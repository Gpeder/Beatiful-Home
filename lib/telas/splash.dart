        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              leading: Text('The best simple place where you discover most wonderful furnitures and make your home beautiful', style: TextStyle(fontSize: 18, color: Color(0xff808080),letterSpacing: 1,),),
            ),
            SizedBox(height: 50,),
          Container(
            alignment: Alignment.center,
